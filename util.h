...
#define __io_set0(var,bit)       __asm__("set0.io "_STR_VAR(var)", #"_STR(bit)"\n")
#define __io_set1(var,bit)       __asm__("set1.io "_STR_VAR(var)", #"_STR(bit)"\n")
#define __mem_set0(var,bit)       __asm__("set0 "_STR_VAR(var)", #"_STR(bit)"\n")
#define __mem_set1(var,bit)       __asm__("set1 "_STR_VAR(var)", #"_STR(bit)"\n")
